    ...
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
        ...
        return (0, tslib_1.__generator)(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    e_1 = _b.sent();
                    console_logger_1.ConsoleLogger.error("Header " + req.params.source + "/" + req.params.id, e_1);
                    if (!headerWritten) {
                        res.writeHead(404);
                    }
                    return [3 /*break*/, 5];
    ...
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
        ...
        return (0, tslib_1.__generator)(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    e_2 = _a.sent();
                    console_logger_1.ConsoleLogger.error("Query Box " + JSON.stringify(req.params || {}) + " | " + JSON.stringify(req.query || {}), e_2);
                    response.do404();
                    return [3 /*break*/, 5];
                case 4:
                    response.end();
