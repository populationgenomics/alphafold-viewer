...
var CreateOrbitalVolumeParamBase = {
    ...
    gridSpacing: PD.ObjectList({ atomCount: PD.Numeric(0), spacing: PD.Numeric(0.35, { min: 0.1, max: 2, step: 0.01 }) }, function (e) { return "Atoms " + e.atomCount + ": " + e.spacing; }, {
        defaultValue: [
...
export var CreateOrbitalVolume = PluginStateTransform.BuiltIn({
    ...
    params: function (a) {
        ...
        return __assign({ index: PD.Select(0, a.data.orbitals.map(function (o, i) { return [i, "[" + (i + 1) + "] " + o.energy.toFixed(4)]; })) }, CreateOrbitalVolumeParamBase);
    }
})({
