...
var ActionMenu = /** @class */ (function (_super) {
    ...
    ActionMenu.prototype.render = function () {
        ...
        return (0, jsx_runtime_1.jsxs)("div", (0, tslib_1.__assign)({ className: "msp-action-menu-options" + (cmd.header ? '' : ' msp-action-menu-options-no-header') }, { children: [cmd.header && (0, jsx_runtime_1.jsx)(common_1.ControlGroup, (0, tslib_1.__assign)({ header: cmd.header, title: cmd.title, initialExpanded: true, hideExpander: true, hideOffset: true, onHeaderClick: this.hide, topRightIcon: icons_1.CloseSvg }, { children: section }), void 0), !cmd.header && section] }), void 0);
    };
    return ActionMenu;
}(React.PureComponent));
...
var Section = /** @class */ (function (_super) {
    ...
    Object.defineProperty(Section.prototype, "basicHeader", {
        get: function () {
            var _a = this.state, header = _a.header, hasCurrent = _a.hasCurrent;
            return (0, jsx_runtime_1.jsx)("div", (0, tslib_1.__assign)({ className: 'msp-control-group-header', style: { marginTop: '1px' } }, { children: (0, jsx_runtime_1.jsx)(common_1.Button, (0, tslib_1.__assign)({ noOverflow: true, icon: this.state.isExpanded ? icons_1.ArrowDropDownSvg : icons_1.ArrowRightSvg, onClick: this.toggleExpanded, title: "Click to " + (this.state.isExpanded ? 'collapse' : 'expand') + ". " + ((header === null || header === void 0 ? void 0 : header.description) ? header === null || header === void 0 ? void 0 : header.description : '') }, { children: hasCurrent ? (0, jsx_runtime_1.jsx)("b", { children: header === null || header === void 0 ? void 0 : header.label }, void 0) : header === null || header === void 0 ? void 0 : header.label }), void 0) }), void 0);
        },
        enumerable: false,
        configurable: true
    });
