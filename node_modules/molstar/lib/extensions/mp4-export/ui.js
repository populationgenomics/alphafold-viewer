...
var Mp4EncoderUI = /** @class */ (function (_super) {
    ...
    Mp4EncoderUI.prototype.downloadControls = function () {
        var _this = this;
        return _jsxs(_Fragment, { children: [_jsx("div", __assign({ className: 'msp-control-offset msp-help-text' }, { children: _jsx("div", __assign({ className: 'msp-help-description', style: { textAlign: 'center' } }, { children: "Rendering successful!" }), void 0) }), void 0), _jsx(Button, __assign({ icon: GetAppSvg, onClick: this.save, style: { marginTop: 1 } }, { children: "Save Animation" }), void 0), _jsx(Button, __assign({ onClick: function () { return _this.setState({ data: void 0 }); }, style: { marginTop: 6 } }, { children: "Clear" }), void 0)] }, void 0);
    };
    Mp4EncoderUI.prototype.renderControls = function () {
        ...
        return _jsxs(_Fragment, { children: [_jsx(ParameterControls, { params: ctrl.behaviors.animations.value, values: { current: current === null || current === void 0 ? void 0 : current.anim.name }, onChangeValues: function (xs) { return ctrl.setCurrent(xs.current); }, isDisabled: this.state.busy }, void 0), current && _jsx(ParameterControls, { params: current.params, values: current.values, onChangeValues: function (xs) { return ctrl.setCurrentParams(xs); }, isDisabled: this.state.busy }, void 0), _jsx("div", __assign({ className: 'msp-control-offset msp-help-text' }, { children: _jsxs("div", __assign({ className: 'msp-help-description', style: { textAlign: 'center' } }, { children: ["Resolution: ", info.width, "x", info.height, _jsx("br", {}, void 0), "Adjust in viewport using ", _jsx(Icon, { svg: CameraOutlinedSvg, inline: true }, void 0)] }), void 0) }), void 0), _jsx(ParameterControls, { params: Mp4AnimationParams, values: ctrl.behaviors.params.value, onChangeValues: function (xs) { return ctrl.behaviors.params.next(xs); }, isDisabled: this.state.busy }, void 0), _jsx(Button, __assign({ onClick: this.generate, style: { marginTop: 1 }, disabled: this.state.busy || !canApply.canApply, commit: canApply.canApply ? 'on' : 'off' }, { children: canApply.canApply ? 'Render' : (_a = canApply.reason) !== null && _a !== void 0 ? _a : 'Invalid params/state' }), void 0)] }, void 0);
    };
