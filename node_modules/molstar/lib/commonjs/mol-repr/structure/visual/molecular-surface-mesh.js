...
exports.MolecularSurfaceMeshParams = (0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)({}, units_visual_1.UnitsMeshParams), molecular_surface_1.MolecularSurfaceCalculationParams), common_1.CommonSurfaceParams), color_1.ColorSmoothingParams);
//
...
function MolecularSurfaceMeshVisual(materialId) {
    return (0, units_visual_1.UnitsMeshVisual)({
        ...
        processValues: function (values, geometry, props, theme, webgl) {
            ...
            var csp = (0, color_1.getColorSmoothingProps)(props, theme, resolution);
            if (csp) {
                (0, color_1.applyMeshColorSmoothing)(values, csp.resolution, csp.stride, webgl, colorTexture);
