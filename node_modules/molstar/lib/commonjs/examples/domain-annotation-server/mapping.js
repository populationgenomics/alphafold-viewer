...
function writeDomain(enc, domain) {
    if (!domain)
        return;
    enc.writeCategory({ name: "pdbx_" + domain.name + "_domain_annotation", instance: function () { return cif_1.CifWriter.Category.ofTable(domain.domains); } });
    enc.writeCategory({ name: "pdbx_" + domain.name + "_domain_mapping", instance: function () { return cif_1.CifWriter.Category.ofTable(domain.mappings); } });
}
