...
var VolumeFromDsn6 = objects_1.PluginStateTransform.BuiltIn({
    ...
    apply: function (_a) {
        var _this = this;
        var a = _a.a, params = _a.params;
        return mol_task_1.Task.create('Create volume from DSN6/BRIX', function (ctx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            var volume, props;
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, dsn6_1.volumeFromDsn6)(a.data, (0, tslib_1.__assign)((0, tslib_1.__assign)({}, params), { label: a.data.name || a.label })).runInContext(ctx)];
                    case 1:
                        volume = _a.sent();
...
var VolumeFromCube = objects_1.PluginStateTransform.BuiltIn({
    ...
    to: objects_1.PluginStateObject.Volume.Data,
    params: function (a) {
        var dataIndex = a ? param_definition_1.ParamDefinition.Select(0, a.data.header.dataSetIds.map(function (id, i) { return [i, "" + id]; })) : param_definition_1.ParamDefinition.Numeric(0);
        return {
            dataIndex: dataIndex,
            entryId: param_definition_1.ParamDefinition.Text(''),
        };
