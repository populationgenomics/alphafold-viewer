...
function getSchema() {
    ...
    return {
        ...
        paths: (_a = {},
            _a[config_1.ServerConfig.apiPrefix + "/{source}/{id}/"] = {
                get: {
                    tags: ['General'],
            ...
            _a[config_1.ServerConfig.apiPrefix + "/{source}/{id}/box/{a1,a2,a3}/{b1,b2,b3}/"] = {
                get: {
                    tags: ['General'],
            ...
            _a[config_1.ServerConfig.apiPrefix + "/{source}/{id}/cell/"] = {
                get: {
                    tags: ['General'],
