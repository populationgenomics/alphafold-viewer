...
var StateExportImportControls = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(StateExportImportControls, _super);
...
var LocalStateSnapshotParams = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(LocalStateSnapshotParams, _super);
    ...
    LocalStateSnapshotParams.prototype.render = function () {
        return (0, jsx_runtime_1.jsx)(parameters_1.ParameterControls, { params: state_1.PluginState.SnapshotParams, values: this.plugin.state.snapshotParams.value, onChangeValues: this.plugin.state.setSnapshotParams }, void 0);
    };
...
var LocalStateSnapshots = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(LocalStateSnapshots, _super);
...
var LocalStateSnapshotList = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(LocalStateSnapshotList, _super);
...
var RemoteStateSnapshots = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(RemoteStateSnapshots, _super);
    function RemoteStateSnapshots() {
        ...
        _this.refresh = function () { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        for (_i = 0, json_1 = json; _i < json_1.length; _i++) {
                            e = json_1[_i];
                            entries.set(e.id, (0, tslib_1.__assign)((0, tslib_1.__assign)({}, e), { url: this.serverUrl("get/" + e.id), removeUrl: this.serverUrl("remove/" + e.id) }));
                        }
                        if (this._mounted)
        ...
        _this.upload = function () { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.setState({ isBusy: true });
        ...
        _this.fetch = function (e) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            var id, entry;
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        _this.remove = function (e) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            var id, entry, _a;
    ...
    RemoteStateSnapshots.prototype.render = function () {
        ...
        return (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(common_1.SectionHeader, { title: 'Remote States', accent: 'blue' }, void 0), !this.props.listOnly && (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(parameters_1.ParameterControls, { params: this.Params, values: this.state.params, onEnter: this.upload, onChange: function (p) {
                                var _a;
                                _this.setState({ params: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, _this.state.params), (_a = {}, _a[p.name] = p.value, _a)) });
                            }, isDisabled: this.state.isBusy }, void 0), (0, jsx_runtime_1.jsxs)("div", (0, tslib_1.__assign)({ className: 'msp-flex-row' }, { children: [(0, jsx_runtime_1.jsx)(common_1.IconButton, { onClick: this.refresh, disabled: this.state.isBusy, svg: icons_1.RefreshSvg }, void 0), (0, jsx_runtime_1.jsx)(common_1.Button, (0, tslib_1.__assign)({ icon: icons_1.CloudUploadSvg, onClick: this.upload, disabled: this.state.isBusy, commit: true }, { children: "Upload" }), void 0)] }), void 0)] }, void 0), (0, jsx_runtime_1.jsx)(RemoteStateSnapshotList, { entries: this.state.entries, isBusy: this.state.isBusy, serverUrl: this.state.params.options.serverUrl, fetch: this.fetch, remove: this.props.listOnly ? void 0 : this.remove }, void 0), this.props.listOnly && (0, jsx_runtime_1.jsxs)("div", (0, tslib_1.__assign)({ style: { marginTop: '10px' } }, { children: [(0, jsx_runtime_1.jsx)(parameters_1.ParameterControls, { params: this.ListOnlyParams, values: this.state.params, onEnter: this.upload, onChange: function (p) {
                                var _a;
                                _this.setState({ params: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, _this.state.params), (_a = {}, _a[p.name] = p.value, _a)) });
                            }, isDisabled: this.state.isBusy }, void 0), (0, jsx_runtime_1.jsx)("div", (0, tslib_1.__assign)({ className: 'msp-flex-row' }, { children: (0, jsx_runtime_1.jsx)(common_1.Button, (0, tslib_1.__assign)({ onClick: this.refresh, disabled: this.state.isBusy, icon: icons_1.RefreshSvg }, { children: "Refresh" }), void 0) }), void 0)] }), void 0)] }, void 0);
    };
...
var RemoteStateSnapshotList = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(RemoteStateSnapshotList, _super);
    function RemoteStateSnapshotList() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.open = function (e) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            var id, entry, url, qi;
            return (0, tslib_1.__generator)(this, function (_a) {
                id = e.currentTarget.getAttribute('data-id');
                if (!id)
