        ...
        return mol_task_1.Task.create('State Transaction', function (ctx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 6:
                        _a.sent();
                        this.events.log.next(log_entry_1.LogEntry.error('' + e_1));
                        _a.label = 7;
                    case 7:
                        if (isNested) {
                ...
                case 2:
                    ...
                    if (update_2.action === 'created') {
                        ...
                        if (!isNull && !ctx.options.doNotLogTiming)
                            ctx.parent.events.log.next(log_entry_1.LogEntry.info("Created " + update_2.obj.label + " in " + (0, now_1.formatTimespan)(time) + "."));
                    }
                    else if (update_2.action === 'updated') {
                        isNull = update_2.obj === object_1.StateObject.Null;
                        if (!isNull && !ctx.options.doNotLogTiming)
                            ctx.parent.events.log.next(log_entry_1.LogEntry.info("Updated " + update_2.obj.label + " in " + (0, now_1.formatTimespan)(time) + "."));
                    }
