    ...
    PluginContext.prototype.initViewer = function (canvas, container, canvas3dContext) {
        ...
        try {
            ...
            if (canvas3dContext) {
                ...
                this.canvas3dContext = canvas3d_1.Canvas3DContext.fromCanvas(canvas, { antialias: antialias, preserveDrawingBuffer: preserveDrawingBuffer, pixelScale: pixelScale, pickScale: pickScale, enableWboit: enableWboit, preferWebGl1: preferWebGl1 });
                this.canvas3dContext = canvas3d_1.Canvas3DContext.fromCanvas(canvas, { antialias: antialias, preserveDrawingBuffer: preserveDrawingBuffer, pixelScale: pixelScale, pickScale: pickScale, pickPadding: pickPadding, enableWboit: enableWboit });
            }
