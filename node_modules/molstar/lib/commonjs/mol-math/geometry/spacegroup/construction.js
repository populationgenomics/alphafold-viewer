...
(function (Spacegroup) {
    ...
    function getSymmetryOperator(spacegroup, spgrOp, i, j, k) {
        ...
        return geometry_1.SymmetryOperator.create(spgrOp + 1 + "_" + (5 + i) + (5 + j) + (5 + k), operator, { hkl: linear_algebra_1.Vec3.create(i, j, k), spgrOp: spgrOp });
    }
    ...
    function getSymmetryOperatorRef(spacegroup, spgrOp, i, j, k, ref) {
        ...
        return geometry_1.SymmetryOperator.create(spgrOp + 1 + "_" + (5 + _i) + (5 + _j) + (5 + _k), operator, { hkl: linear_algebra_1.Vec3.create(_i, _j, _k), spgrOp: spgrOp });
    }
