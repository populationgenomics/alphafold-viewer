...
var CreateOrbitalVolumeParamBase = {
    ...
    gridSpacing: param_definition_1.ParamDefinition.ObjectList({ atomCount: param_definition_1.ParamDefinition.Numeric(0), spacing: param_definition_1.ParamDefinition.Numeric(0.35, { min: 0.1, max: 2, step: 0.01 }) }, function (e) { return "Atoms " + e.atomCount + ": " + e.spacing; }, {
        defaultValue: [
...
exports.CreateOrbitalVolume = objects_1.PluginStateTransform.BuiltIn({
    ...
    params: function (a) {
        ...
        return (0, tslib_1.__assign)({ index: param_definition_1.ParamDefinition.Select(0, a.data.orbitals.map(function (o, i) { return [i, "[" + (i + 1) + "] " + o.energy.toFixed(4)]; })) }, CreateOrbitalVolumeParamBase);
    }
})({
...
function volumeParams(plugin, volume, params) {
    ...
    return (0, volume_representation_params_1.createVolumeRepresentationParams)(plugin, volume.data, params.directVolume ? {
        type: 'direct-volume',
        typeParams: {
            alpha: params.alpha,
            renderMode: {
