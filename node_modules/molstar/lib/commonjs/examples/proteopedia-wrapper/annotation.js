            ...
            return (0, tslib_1.__generator)(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        url = assets_1.Asset.getUrlAsset(ctx.assetManager, "https://proteopedia.org/cgi-bin/cnsrf?" + id);
                    ...
                    case 1:
                        ...
                        for (rI = 0; rI < residueCount; rI++) {
                            ...
                            key = model.atomicHierarchy.chains.auth_asym_id.value(cI) + " " + model.atomicHierarchy.residues.auth_seq_id.value(rI);
