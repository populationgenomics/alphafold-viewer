...
(function (Test) {
    ...
    function run() {
        ...
        suite
            ...
            .add(N + " str", function () { return string_builder_1.StringBuilder.getString(build(data, N)); })
            .add(N + " str ws", function () { return string_builder_1.StringBuilder.getString(buildWS(data, N)); })
