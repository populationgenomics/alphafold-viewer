...
exports.LazyVolume = exports.ParseJson = exports.ImportJson = exports.ImportString = exports.ParseDx = exports.ParseDsn6 = exports.ParseCcp4 = exports.ParsePly = exports.ParsePsf = exports.ParseCube = exports.ParseCif = exports.ParseBlob = exports.ReadFile = exports.RawData = exports.DownloadBlob = exports.Download = void 0;
var tslib_1 = require("tslib");
var CCP4 = (0, tslib_1.__importStar)(require("../../mol-io/reader/ccp4/parser"));
var cif_1 = require("../../mol-io/reader/cif");
var DSN6 = (0, tslib_1.__importStar)(require("../../mol-io/reader/dsn6/parser"));
var PLY = (0, tslib_1.__importStar)(require("../../mol-io/reader/ply/parser"));
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        cache.assets = assets;
                        return [2 /*return*/, new objects_1.PluginStateObject.Data.Blob(entries, { label: 'Data Blob', description: entries.length + " " + (entries.length === 1 ? 'entry' : 'entries') })];
                }
            });
        }); });
    },
            ...
            return (0, tslib_1.__generator)(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 3:
                        _c++;
                        return [3 /*break*/, 1];
                    case 4: return [2 /*return*/, new objects_1.PluginStateObject.Format.Blob(entries, { label: 'Format Blob', description: entries.length + " " + (entries.length === 1 ? 'entry' : 'entries') })];
                }
            });
        }); });
    },
...
var ParseDx = objects_1.PluginStateTransform.BuiltIn({
    ...
    apply: function (_a) {
        var _this = this;
        var a = _a.a;
        return mol_task_1.Task.create('Parse DX', function (ctx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            var parsed;
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
    ...
    apply: function (_a) {
        ...
        return mol_task_1.Task.create('Lazy Volume', function (ctx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                ...
                return [2 /*return*/, new objects_1.PluginStateObject.Volume.Lazy(params, { label: "" + (entryId || params.url), description: 'Lazy Volume' })];
            });
        }); });
    }
});
