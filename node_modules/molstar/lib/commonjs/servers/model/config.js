...
exports.ModelServerConfig = (0, tslib_1.__assign)({}, DefaultModelServerConfig);
exports.ModelServerConfigTemplate = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, DefaultModelServerConfig), { defaultSource: 'pdb-bcif', sourceMap: [
...
function validateConfigAndSetupSourceMap() {
    ...
    exports.mapSourceAndIdToFilename = new Function('source', 'id', (0, tslib_1.__spreadArray)((0, tslib_1.__spreadArray)([
        'switch (source.toLowerCase()) {'
    ], exports.ModelServerConfig.sourceMap.map(function (_a) {
        var source = _a[0], path = _a[1], format = _a[2];
        return "case '" + source.toLowerCase() + "': return [`" + path + "`, '" + format + "'];";
    }), true), [
        '}',
    ], false).join('\n'));
}
