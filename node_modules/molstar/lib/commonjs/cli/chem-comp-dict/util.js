...
exports.getEncodedCif = exports.readPVCD = exports.readCCD = exports.readFileAsCollection = exports.ensureDataAvailable = exports.ensureAvailable = void 0;
...
function ensureDataAvailable(forceDownload) {
    if (forceDownload === void 0) { forceDownload = false; }
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
        return (0, tslib_1.__generator)(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, ensureAvailable(CCD_PATH, CCD_URL, forceDownload)];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, ensureAvailable(PVCD_PATH, PVCD_URL, forceDownload)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
