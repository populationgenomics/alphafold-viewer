        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    url = Asset.getUrlAsset(plugin.managers.asset, baseUrl + "/extras/rna_allpoints.json");
            ...
            switch (_d.label) {
                case 0:
                    ...
                    if (file) {
                        ...
                        url = Asset.getUrlAsset(plugin.managers.asset, params.baseUrl + "/membranes/" + name + ".bcif");
