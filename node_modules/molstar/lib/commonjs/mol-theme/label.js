...
exports.dihedralLabel = exports.angleLabel = exports.distanceLabel = exports.elementLabel = exports._bundleLabel = exports.bundleLabel = exports.bondLabel = exports.structureElementStatsLabel = exports.lociLabel = exports.DefaultLabelOptions = void 0;
...
function otherLabel(count, location, granularity, hidePrefix, reverse, condensed) {
    return elementLabel(location, { granularity: granularity, hidePrefix: hidePrefix, reverse: reverse, condensed: condensed }) + " <small>[+ " + countLabel(count - 1, "other " + (0, string_1.capitalize)(granularity)) + "]</small>";
}
...
function distanceLabel(pair, options) {
    ...
    var distance = linear_algebra_1.Vec3.distance(cA, cB).toFixed(2) + " " + o.unitLabel;
    if (o.measureOnly)
        return distance;
...
function angleLabel(triple, options) {
    ...
    var angle = (0, misc_1.radToDeg)(linear_algebra_1.Vec3.angle(vAB, vCB)).toFixed(2) + "\u00B0";
    if (o.measureOnly)
        return angle;
...
function dihedralLabel(quad, options) {
    ...
    var dihedral = (0, misc_1.radToDeg)(linear_algebra_1.Vec3.dihedralAngle(cA, cB, cC, cD)).toFixed(2) + "\u00B0";
    if (o.measureOnly)
        return dihedral;
