...
var PluginUIComponent = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(PluginUIComponent, _super);
...
var PurePluginUIComponent = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(PurePluginUIComponent, _super);
...
var CollapsableControls = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(CollapsableControls, _super);
    ...
    CollapsableControls.prototype.render = function () {
        ...
        return (0, jsx_runtime_1.jsxs)("div", (0, tslib_1.__assign)({ className: wrapClass }, { children: [(0, jsx_runtime_1.jsx)("div", (0, tslib_1.__assign)({ className: 'msp-transform-header' }, { children: (0, jsx_runtime_1.jsxs)(common_1.Button, (0, tslib_1.__assign)({ icon: this.state.brand ? void 0 : this.state.isCollapsed ? icons_1.ArrowRightSvg : icons_1.ArrowDropDownSvg, noOverflow: true, onClick: this.toggleCollapsed, className: this.state.brand ? "msp-transform-header-brand msp-transform-header-brand-" + this.state.brand.accent : void 0, title: "Click to " + (this.state.isCollapsed ? 'expand' : 'collapse') }, { children: [(0, jsx_runtime_1.jsx)(icons_1.Icon, { svg: (_a = this.state.brand) === null || _a === void 0 ? void 0 : _a.svg, inline: true }, void 0), this.state.header, (0, jsx_runtime_1.jsx)("small", (0, tslib_1.__assign)({ style: { margin: '0 6px' } }, { children: this.state.isCollapsed ? '' : this.state.description }), void 0)] }), void 0) }), void 0), !this.state.isCollapsed && this.renderControls()] }), void 0);
    };
