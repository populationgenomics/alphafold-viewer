...
var ScaleLegend = /** @class */ (function (_super) {
    ...
    ScaleLegend.prototype.render = function () {
        ...
        var colors = legend.colors.map(function (c) { return Array.isArray(c) ? color_1.Color.toStyle(c[0]) + " " + 100 * c[1] + "%" : color_1.Color.toStyle(c); }).join(', ');
        return (0, jsx_runtime_1.jsx)("div", (0, tslib_1.__assign)({ className: 'msp-scale-legend' }, { children: (0, jsx_runtime_1.jsxs)("div", (0, tslib_1.__assign)({ style: { background: "linear-gradient(to right, " + colors + ")" } }, { children: [(0, jsx_runtime_1.jsx)("span", (0, tslib_1.__assign)({ style: { float: 'left' } }, { children: legend.minLabel }), void 0), (0, jsx_runtime_1.jsx)("span", (0, tslib_1.__assign)({ style: { float: 'right' } }, { children: legend.maxLabel }), void 0)] }), void 0) }), void 0);
    };
    return ScaleLegend;
}(React.PureComponent));
