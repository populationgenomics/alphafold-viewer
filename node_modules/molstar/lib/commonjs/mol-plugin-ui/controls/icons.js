...
function Icon(props) {
    if (!props.svg)
        return null;
    return (0, jsx_runtime_1.jsx)("span", (0, tslib_1.__assign)({ className: "msp-icon msp-material-icon" + (props.inline ? ' msp-icon-inline' : ''), title: props.title, style: props.style }, { children: (0, jsx_runtime_1.jsx)(props.svg, {}, void 0) }), void 0);
}
exports.Icon = Icon;
//
