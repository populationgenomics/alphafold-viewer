...
(function (RootStructureDefinition) {
    function getParams(model, defaultValue) {
        ...
        var assemblyIds = symmetry ? symmetry.assemblies.map(function (a) { return [a.id, a.id + ": " + (0, string_1.stringToWords)(a.details)]; }) : [];
        ...
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        s = _a.sent();
                        objProps = { label: "Assembly " + id, description: structure_1.Structure.elementDescription(s) };
        ...
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
            ...
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        s = _a.sent();
                        objProps = { label: "Symmetry [" + ijkMin + "] to [" + ijkMax + "]", description: structure_1.Structure.elementDescription(s) };
                        return [2 /*return*/, new objects_1.PluginStateObject.Molecule.Structure(s, objProps)];
                }
            });
        });
