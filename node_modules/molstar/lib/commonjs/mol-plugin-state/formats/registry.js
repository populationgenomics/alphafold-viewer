...
var DataFormatRegistry = /** @class */ (function () {
    function DataFormatRegistry() {
        ...
        for (var _b = 0, BuiltInStructureFormats_1 = structure_1.BuiltInStructureFormats; _b < BuiltInStructureFormats_1.length; _b++) {
            var _c = BuiltInStructureFormats_1[_b], id = _c[0], p = _c[1];
            this.add(id, p);
        }
        for (var _d = 0, BuiltInShapeFormats_1 = shape_1.BuiltInShapeFormats; _d < BuiltInShapeFormats_1.length; _d++) {
            var _e = BuiltInShapeFormats_1[_d], id = _e[0], p = _e[1];
            this.add(id, p);
        }
        for (var _f = 0, BuiltInTrajectoryFormats_1 = trajectory_1.BuiltInTrajectoryFormats; _f < BuiltInTrajectoryFormats_1.length; _f++) {
