...
exports.PolymerTraceMeshParams = {
    ...
    arrowFactor: param_definition_1.ParamDefinition.Numeric(1.5, { min: 0, max: 3, step: 0.1 }),
    tubularHelices: param_definition_1.ParamDefinition.Boolean(false),
        ...
        if (v.initial === true && v.final === true) {
            ...
            if (radialSegments === 2) {
                if (isNucleicType && !v.isCoarseBackbone) {
                    ...
                    (0, ribbon_1.addRibbon)(builderState, curvePoints, binormalVectors, normalVectors, segmentCount, heightValues, widthValues, 0);
                }
                else {
                ...
                (0, tube_1.addTube)(builderState, curvePoints, normalVectors, binormalVectors, segmentCount, radialSegments, widthValues, heightValues, startCap, endCap);
            }
        }
        ++i;
    }
